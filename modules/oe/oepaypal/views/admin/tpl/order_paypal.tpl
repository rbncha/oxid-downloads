...
[{if $oOrder}]
        ...
        <tr>
            <td class="edittext" valign="top" >
                <table class="paypalActionsTable" width="98%">
                    ...
                    [{/if}]
                    [{if $oOrderActionManager->isActionAvailable('void') || $oOrderActionManager->isActionAvailable('reauthorize')}]
                    <tr>
                        ...
                        <td class="edittext">
                            ...
                            <button id="reauthorizeButton" class="actionLink"
                               data-action="reauthorize"
                               data-statuslist="[{$oOrderPaymentStatusCalculator->getSuggestStatus('reauthorize')}]"
                               href="#">
                                [{oxmultilang ident="OEPAYPAL_REAUTHORIZE"}]
                            </button>
                        </td>
                    </tr>
                    [{/if}]
    ...
    <div id="paypalActionsBlocks">
        ...
        <div id="reauthorizeBlock" class="paypalActionsBlock">
            <h3>[{oxmultilang ident="OEPAYPAL_AUTHORIZATION"}]</h3>
            <div class="paypalStatusListPlaceholder"></div>
            <p class="paypalActionsBlockNotice">
                <label>[{oxmultilang ident="OEPAYPAL_COMMENT"}]</label></br>
            ...
            <p class="paypalActionsButtons">
                <input id="reauthorizeSubmit" type="submit" name="action_submit" value="[{oxmultilang ident="OEPAYPAL_REAUTHORIZE"}]" >
            </p>
        </div>
